...
public class ModSoundType extends SoundType {
    public static ModSoundType BLOCK_CHANGE = new ModSoundType(1.0F, 1.0F, SoundEvents.STONE_BREAK, SoundEvents.STONE_STEP, SoundEvents.STONE_PLACE, SoundInit.BLOCK_CHANGE_IN_WORLD, SoundEvents.STONE_FALL);
